...
def capture_from_camera(picam: Picamera2, cam_num: int, timestamp: str, outdir: str, 
                       burst_count: int = 1, jpeg_quality: int = 90):
    """
...
def sequential_capture_cycle(picam0: Picamera2, picam1: Picamera2, 
                             outdir: str, burst_count: int = 1, jpeg_quality: int = 90):
    """
...
def main():
    ...
    class Args:
        def __init__(self, exposure=1000, gain=1.0, jpeg_quality=90, outdir="captures",
                 burst=5, no_metadata=False):
    ...
    sequential_capture_cycle(picam0, picam1, working_dir,burst_count=args.burst, 
